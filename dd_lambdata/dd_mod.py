...
class MetricConvert:
    ...
    32 degrees that should be addressable with the 'int' variable (short for 'intercept'). Any other unit
    conversion with an aligned 0 point, such as length or weight,
    should set 'int' equal to 0.
    '''
    def __init__(
                self, val_to_conv=None, int=-32,
    ...
    def old_to_si(self, val_to_conv):
        ...
        '''
        c = (self.int + val_to_conv) * self.coeff
        return print(
                    '{} {} equals {} {}'.format(
                        c, self.si_unit,
    ...
    def si_to_old(self, val_to_conv):
        ...
        '''
        f = (val_to_conv / self.coeff) - self.int
        return print(
                    '{} {} equals {} {}'.format(
                        f, self.old_unit,
